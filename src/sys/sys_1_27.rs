...
unsafe extern "C" {
    ...
    pub fn libinput_tablet_tool_has_tilt(tool: *mut libinput_tablet_tool) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_tablet_tool_has_slider(tool: *mut libinput_tablet_tool) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    ...
    pub fn libinput_tablet_tool_has_size(tool: *mut libinput_tablet_tool) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    #[doc = " @ingroup event_tablet\n\n Return whether the tablet tool has a relative wheel.\n\n @param tool The tool to check the axis capabilities of\n @return Nonzero if the axis is available, zero otherwise.\n\n @since 1.2"]
    pub fn libinput_tablet_tool_has_wheel(tool: *mut libinput_tablet_tool) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_tablet_tool_is_unique(tool: *mut libinput_tablet_tool) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
pub struct libinput_interface {
    ...
    pub open_restricted: ::core::option::Option<
        unsafe extern "C" fn(
    ...
    pub close_restricted: ::core::option::Option<
        unsafe extern "C" fn(fd: ::core::ffi::c_int, user_data: *mut ::core::ffi::c_void),
    >,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of libinput_interface"][::core::mem::size_of::<libinput_interface>() - 16usize];
    ["Alignment of libinput_interface"][::core::mem::align_of::<libinput_interface>() - 8usize];
    ["Offset of field: libinput_interface::open_restricted"]
        [::core::mem::offset_of!(libinput_interface, open_restricted) - 0usize];
    ["Offset of field: libinput_interface::close_restricted"]
        [::core::mem::offset_of!(libinput_interface, close_restricted) - 8usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_get_fd(libinput: *mut libinput) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    ...
    pub fn libinput_dispatch(libinput: *mut libinput) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_set_user_data(libinput: *mut libinput, user_data: *mut ::core::ffi::c_void);
}
unsafe extern "C" {
    #[doc = " @ingroup base\n\n Get the caller-specific data associated with this context, if any.\n\n @param libinput A previously initialized libinput context\n @return The caller-specific data previously assigned in\n libinput_set_user_data(), libinput_path_create_context() or\n libinput_udev_create_context()."]
    pub fn libinput_get_user_data(libinput: *mut libinput) -> *mut ::core::ffi::c_void;
}
unsafe extern "C" {
    #[doc = " @ingroup base\n\n Resume a suspended libinput context. This re-enables device\n monitoring and adds existing devices.\n\n @param libinput A previously initialized libinput context\n @see libinput_suspend\n\n @return 0 on success or -1 on failure"]
    pub fn libinput_resume(libinput: *mut libinput) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
pub type libinput_log_handler = ::core::option::Option<
    unsafe extern "C" fn(
        libinput: *mut libinput,
...
unsafe extern "C" {
    ...
    pub fn libinput_seat_get_user_data(seat: *mut libinput_seat) -> *mut ::core::ffi::c_void;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_seat_get_physical_name(seat: *mut libinput_seat) -> *const ::core::ffi::c_char;
}
unsafe extern "C" {
    ...
    pub fn libinput_seat_get_logical_name(seat: *mut libinput_seat) -> *const ::core::ffi::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_device_get_user_data(device: *mut libinput_device) -> *mut ::core::ffi::c_void;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_device_get_sysname(device: *mut libinput_device) -> *const ::core::ffi::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn libinput_device_get_id_vendor(device: *mut libinput_device) -> ::core::ffi::c_uint;
}
unsafe extern "C" {
