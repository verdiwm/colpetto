...
fn bindgen_test_layout_libinput_interface() {
    const UNINIT: ::core::mem::MaybeUninit<libinput_interface> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<libinput_interface>(),
        16usize,
        concat!("Size of: ", stringify!(libinput_interface))
    );
    assert_eq!(
        ::core::mem::align_of::<libinput_interface>(),
        8usize,
        concat!("Alignment of ", stringify!(libinput_interface))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).open_restricted) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).close_restricted) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(libinput_interface),
